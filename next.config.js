...
const publicRuntimeConfig = {
  ...
  DEFAULT_IMG_URL: getAddress2({
    ...
    oprs: 'https://www.gamevilcom2us.net',
    local: 'https://connect.jandi.io',
  }),
  ASSET_DIR: getAddress2({
    production: 'https://connect.jandi.io/connect',
    alpha: 'https://alpha-cdn.jandi.io/connect',
    development: 'https://connect.jandi.io/connect',
    oprs: 'https://www.gamevilcom2us.net/connect',
    local: '',
  }),
  BASE_PATH: basePath,
  L10N_URL: getAddress({
