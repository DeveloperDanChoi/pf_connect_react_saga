        ...
        <div className='inner'>
          <div className='connect-info-box'>
            ...
            <div className='connect-right-box'>
              ...
              <button type='button' className='btn-icon' onClick={() => template1.deleteConnect(googleCalendar, router)}><i className="icon-ic-delete"></i><span className='hidden'>삭제하기</span></button>
            </div>
          </div>
        </div>
      </div>{/* //detail-header */}
