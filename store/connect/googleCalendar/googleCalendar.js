   ...
   */
  {
    ...
    request: {
      ...
      validate: [
        ...
        { name: 'googleId', type: 'string', msg: 'googleId' },
        { name: 'calendarId', type: 'string', msg: 'calendarId' },
        { name: 'calendarSummary', type: 'string', msg: 'calendarSummary' },
...
export const modules = (() => reduxModule.modules.create(initialModules, 'googleCalendar'))();
