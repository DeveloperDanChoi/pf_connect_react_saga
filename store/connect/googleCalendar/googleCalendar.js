...
export const initialState = {
  ...
  input: {
    ...
    botThumbnailFile: '',
    lang: '',
    hasNotificationBefore: '',
    notificationBefore: '',
    hasAllDayNotification: '',
    allDayNotificationBeforeDates: '',
    allDayNotificationHour: '',
    hasDailyScheduleSummary: '',
    dailyScheduleSummary: '',
    hasWeeklyScheduleSummary: '',
    weeklyScheduleSummaryHour: '',
    weeklyScheduleSummaryDayOfWeek: '',
