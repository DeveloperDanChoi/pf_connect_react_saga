...
export const initialState = {
  ...
  input: {
    ...
    lang: '',
    roomId: '',
    showBoardListFromMoved: '',
    showBoardListToMoved: '',
    showBoardMemberCreated: '',
    showBoardRenamed: '',
    showCardArchived: '',
    showCardAttachmentCreated: '',
    showCardChecklistCreated: '',
    showCardChecklistItemCreated: '',
    showCardChecklistItemUpdated: '',
    showCardCommentCreated: '',
    showCardCreated: '',
    showCardDescriptionUpdated: '',
    showCardDueDateUpdated: '',
    showCardLabelCreated: '',
    showCardLabelDeleted: '',
    showCardMemberCreated: '',
    showCardMoved: '',
    showCardRenamed: '',
    showCardUnarchived: '',
    showListArchived: '',
